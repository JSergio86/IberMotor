...
public class MainActivity extends AppCompatActivity {
    ...
    List<Integer> fragmentsWithoutBottomNav = Arrays.asList(R.id.signInFragment, R.id.registerFragment, R.id.ayudaFragment, R.id.editarPerfilFragment, R.id.chatFragment, R.id.descripcionCocheFragment);
    FirebaseAuth mAuth;
